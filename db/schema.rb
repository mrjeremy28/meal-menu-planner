...
ActiveRecord::Schema[7.1].define(version: 2024_04_10_000002) do
  ...
  create_table "ingredients", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "default_quantity_unit_id", null: false
  ...
  create_table "recipe_ingredients", force: :cascade do |t|
    ...
    t.bigint "quantity_unit_id", null: false
    t.string "quantity"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    ...
    t.index ["quantity_unit_id"], name: "index_recipe_ingredients_on_quantity_unit_id"
